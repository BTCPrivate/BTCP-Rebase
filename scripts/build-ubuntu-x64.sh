...
sudo apt-get install build-essential libtool autotools-dev automake pkg-config libssl-dev libevent-dev bsdmainutils python3 libboost-all-dev ccache libsodium-dev libomp-dev curl libgtest-dev -y 
cd ~/BTCP-Rebase/
sudo ./autogen.sh
cd ~/BTCP-Rebase/depends/
sudo make HOST=x86_64-unknown-linux-gnu
cd ~/BTCP-Rebase/
sudo ./configure --prefix=$PWD/depends/x86_64-unknown-linux-gnu
sudo make
