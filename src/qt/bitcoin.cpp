...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // bitcoinprivate: URIs or payment requests:
...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Bitcoin Private can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
int main(int argc, char *argv[])
{
    ...
    // bitcoinprivate: links repeatedly have their payment requests routed to this process:
